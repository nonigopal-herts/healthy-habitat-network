        ...
        <div class="col-md-12">
            ...
            <div class="card card-primary card-outline mb-4">
                ...
                <div class="card-header">
                    <div class="card-title">Product or Services</div>
                </div>
                <!--end::Header-->
                <!--begin::Form-->
                <form action="{{route('product-services.store')}}" method="post" enctype="multipart/form-data">
{{--                    <form>--}}
                    @csrf
                    <!--begin::Body-->
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="product_service_subcategory_id" class="form-select @error('product_service_subcategory_id') is-invalid @enderror" id="product_service_subcategory">
                                @foreach($subcategories as $subcategory)
                                    <option value="{{$subcategory->id}}" {{ old('product_service_subcategory_id', $subcategory->product_service_subcategory_id ?? '') == $subcategory->id ? 'selected' : '' }}>{{$subcategory->name}}</option>
                                @endforeach
                            </select>
